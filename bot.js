...
client.on('message', message => {
    ...
    client.on('message',async msg => {
      ...
      client.on("message", (message) => {
        ...
        『T#kick / لطرد شخص من الدسكورد 』
        『T#ban / لاعطاء شخص باند من الدسكورد 』
        『T#ct / لانشاء روم كتابي 』
        『T#cv / لانشاء روم صوتي 』
        『T#temp on / لتشغيل الرومات المؤقتة 』
        『T#temp off / لاطفاء الرومات المؤقتة 』
        『T#c-channel / لانشاء روم يكون بعدد اعضاء السيرفر 』
        ...
        client.on ("guildMemberAdd", member => {
          ...
          var role = member.guild.roles.find ("name", "Toronto");
          member.addRole (role);
